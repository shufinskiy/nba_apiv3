import re
from nba_apiv3.stats.library.data import players
from nba_apiv3.stats.library.data import player_index_id, player_index_full_name, player_index_first_name, player_index_last_name, player_index_is_active
